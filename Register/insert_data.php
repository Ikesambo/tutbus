<?php
  ...
  class Person{
	  ...
	  function insertDetails(){
		  ...
		  $sql="insert into user(email,username,first_name,surname,password,login_type)
        		values('$this->uniqueNo','$this->username','$this->firstNames','$this->surname','$this->password','$this->regType')";
