...
<!-- Navigation -->
    ...
    <div class="container">   
    <form class="navbar-form   " role="search"  method="post"  style="margin-top:18%;background-color:black;
	      border-radius:20px">
        <div class="form-group" style="width:100%">
		    <br><label>Username</label>
            <br><input type="text" class="form-control" placeholder="Username" name="username" id="username" required style="width:100%"><br>
		    <br><label >Password</label>
            <br><input type="password" class="form-control" placeholder="Password" name="password" id="password" required style="width:100%"><br>
			<span id="error" class="text-danger"></span>

        </div>
        <div>
            <br><button type="submit" class="btn btn-primary"name="login">Login</button><br><br>
			<a href="reset/forgot-password.php">forgot password</a><br>
        </div>
    </form>
...
<?php
  ...
  class Account{
	  ...
	  function auto_update(){
		   ...
		   $query="UPDATE time
           SET numBooked=0
		   WHERE ADDTIME(time,'0:30:0')<CURRENT_TIME())";
